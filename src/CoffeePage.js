...
export default function CoffeePage({open, setFlagCoffeePage, Coffee}) {
    const [butExtra, setButExtra] = React.useState(null);
    const [butSize, setButSize] = React.useState(null);
    const [butMilk, setButMilk] = React.useState(null);
    ...
    <div className={`coffeepage ${open ? "open" : ""}`}>
      <header className="header">
        <div className="ButtonBack">
            ...
            <span className="back-text" onClick={()=>toggleFlagCoffeePage(setFlagCoffeePage)}>BACK TO MENU</span>
        </div>
      ...
      <div className="main">
        ...
        <div className="RightPanel">
          ...
          <div className="PriceRow">
            <div className="price">{Coffee.price + " RUB"}</div>
